      ...
      <div className="w-full h-64 flex flex-row gap-6">
        <div className="bg-cyan-100 flex-[50%] p-6 relative rounded-3xl flex flex-col justify-between text-cyan-900">
          ...
          <div>
            ...
            <p className="text-sm font-semibold mt-1">in 3 days</p>
          </div>
        </div>
        ...
        <div className="bg-green-100 flex-[50%] p-6 relative rounded-3xl flex flex-col justify-between text-green-900">
          ...
          <div>
            ...
            <p className="text-sm font-semibold mt-1">in 5 days</p>
          </div>
        </div>
      </div>

      <div className="w-full h-70 flex flex-row gap-6">
        <div className="bg-purple-100 flex-1 p-6 h-64 rounded-4xl flex flex-col justify-between text-purple-900">
          <div className="flex gap-3">
            <img src="/palette.svg" alt="palette" className=" w-4 h-5 object-contain" />
            <p className="text-sm font-medium flex items-center gap-3">Design</p>
          </div>
          <div>
            ...
            <p className="text-sm font-semibold mt-1">8 hours ago</p>
          </div>
        </div>

        <div className="bg-orange-100 flex-1 p-6 h-64 rounded-4xl flex flex-col justify-between text-orange-900">
          <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm font-semibold mt-1">2 days ago</p>
          </div>
        </div>

        <div className="bg-pink-100 flex-1 p-6 h-64 rounded-4xl flex flex-col justify-between text-pink-900">
          <div className="flex gap-3">
            <img src="/palette.svg" alt="palette" className="w-4 h-5 object-contain" />
            <p className="text-sm font-medium flex items-center gap-3">Design</p>
          </div>
          <div>
            ...
            <p className="text-sm font-semibold mt-1">4 days ago</p>
          </div>
        </div>
      </div>
    </div>
